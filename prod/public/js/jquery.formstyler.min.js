...
x+"</ul></div>");e.append(c);var h=d("li",c),m=0;h.each(function(){d(this).css({display:"inline-block","white-space":"nowrap"});d(this).width()>m&&(m=d(this).width());d(this).css({display:"block","white-space":"normal"})});var l=a.clone().css("width","auto").insertAfter(a),B=l.width();l.remove();B==a.width()?f.width(m):e.width(a.outerWidth());m>c.width()&&c.width(m+c.width()-h.width());a.css({position:"absolute",left:-9999});l=h.filter(".selected");1>l.length&&h.first().addClass("selected sel");var y=e.outerHeight();"auto"==c.css("left")&&c.css({left:0});"auto"==c.css("top")&&c.css({top:y});var r=h.outerHeight(),z=c.css("top");c.hide();l.length&&(g.first().text()!=n.text()&&e.addClass("changed"),e.data("jqfs-class",l.data("jqfs-class")),e.addClass(l.data("jqfs-class")));if(a.is(":disabled"))return e.addClass("disabled"),!1;f.click(function(){a.focus();if(p.selectSmartPositioning){var m=d(window),g=e.offset().top,f=m.height()-y-(g-m.scrollTop()),l=p.selectVisibleOptions,k=6*r,w=r*l;0<l&&6>l&&(k=w);0>f||f<k?(c.height("auto").css({top:"auto",bottom:z}),c.outerHeight()>g-m.scrollTop()-20&&(c.height(Math.floor((g-m.scrollTop()-20)/r)*r),0<l&&6>l?c.height()>k&&c.height(k):6<l&&c.height()>w&&c.height(w))):f>k&&(c.height("auto").css({bottom:"auto",top:z}),c.outerHeight()>f-20&&(c.height(Math.floor((f-20)/r)*r),0<l&&6>l?c.height()>k&&c.height(k):6<l&&c.height()>w&&c.height(w)))}d("div.jqselect").css({zIndex:p.singleSelectzIndex-1}).removeClass("opened focused");e.css({zIndex:p.singleSelectzIndex});c.is(":hidden")?(d("div.jq-selectbox__dropdown:visible").hide(),c.show(),e.addClass("opened")):(c.hide(),e.removeClass("opened"));h.filter(".selected").length&&c.scrollTop(c.scrollTop()+h.filter(".selected").position().top-c.innerHeight()/2+r/2);b(c);return!1});h.hover(function(){d(this).siblings().removeClass("selected")});var A=h.filter(".selected").text();h.filter(".selected").text();h.filter(":not(.disabled):not(.optgroup)").click(function(){var b=d(this),m=b.text();if(A!=m){var l=b.index();b.is(".option")&&(l-=b.prevAll(".optgroup").length);b.addClass("selected sel").siblings().removeClass("selected sel");g.prop("selected",!1).eq(l).prop("selected",!0);A=m;k.text(m);g.first().text()!=m?e.addClass("changed"):e.removeClass("changed");e.data("jqfs-class")&&e.removeClass(e.data("jqfs-class"));e.data("jqfs-class",b.data("jqfs-class"));e.addClass(b.data("jqfs-class"));a.change()}c.hide();e.removeClass("opened")});c.mouseout(function(){d("li.sel",c).addClass("selected")});a.change(function(){k.text(g.filter(":selected").text());h.removeClass("selected sel").not(".optgroup").eq(a[0].selectedIndex).addClass("selected sel")}).focus(function(){e.addClass("focused")}).blur(function(){e.removeClass("focused")}).bind("keydown keyup",function(b){k.text(g.filter(":selected").text());h.removeClass("selected sel").not(".optgroup").eq(a[0].selectedIndex).addClass("selected sel");38!=b.which&&37!=b.which&&33!=b.which||c.scrollTop(c.scrollTop()+h.filter(".selected").position().top);40!=b.which&&39!=b.which&&34!=b.which||c.scrollTop(c.scrollTop()+
h.filter(".selected").position().top-c.innerHeight()+r);13==b.which&&c.hide()});d(document).on("click",function(a){d(a.target).parents().hasClass("jq-selectbox")||"OPTION"==a.target.nodeName||(c.hide().find("li.sel").addClass("selected"),e.removeClass("focused opened"))})}function C(){var e=d("<div"+q+' class="jq-select-multiple jqselect'+s+'"'+u+' style="display: inline-block"></div>');a.after(e);t();e.append('<ul style="position: relative">'+x+"</ul>");var f=d("ul",e).css({"overflow-x":"hidden"}),k=d("li",e).attr("unselectable","on").css({"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","-o-user-select":"none","user-select":"none","white-space":"nowrap"}),n=a.attr("size"),c=f.outerHeight(),h=k.outerHeight();void 0!==n&&0<n?f.css({height:h*n}):f.css({height:4*h});c>e.height()&&(f.css("overflowY","scroll"),b(f),k.filter(".selected").length&&f.scrollTop(f.scrollTop()+k.filter(".selected").position().top));a.is(":disabled")?(e.addClass("disabled"),g.each(function(){d(this).is(":selected")&&k.eq(d(this).index()).addClass("selected")}),e.width(a.outerWidth()),e.width(e.width()-(e.outerWidth()-e.width()))):(e.width(a.outerWidth()),e.width(e.width()-(e.outerWidth()-e.width())),a.css({position:"absolute",left:-9999}),k.filter(":not(.disabled):not(.optgroup)").click(function(b){a.focus();e.removeClass("focused");var c=d(this);b.ctrlKey||c.addClass("selected");b.shiftKey||c.addClass("first");b.ctrlKey||b.shiftKey||c.siblings().removeClass("selected first");b.ctrlKey&&(c.is(".selected")?c.removeClass("selected first"):c.addClass("selected first"),c.siblings().removeClass("first"));if(b.shiftKey){var f=!1,h=!1;c.siblings().removeClass("selected").siblings(".first").addClass("selected");c.prevAll().each(function(){d(this).is(".first")&&(f=!0)});c.nextAll().each(function(){d(this).is(".first")&&(h=!0)});f&&c.prevAll().each(function(){if(d(this).is(".selected"))return!1;d(this).not(".disabled, .optgroup").addClass("selected")});h&&c.nextAll().each(function(){if(d(this).is(".selected"))return!1;d(this).not(".disabled, .optgroup").addClass("selected")});1==k.filter(".selected").length&&c.addClass("first")}g.prop("selected",!1);k.filter(".selected").each(function(){var a=d(this),b=a.index();a.is(".option")&&(b-=a.prevAll(".optgroup").length);g.eq(b).prop("selected",!0)});a.change()}),g.each(function(a){d(this).data("optionIndex",a)}),a.change(function(){k.removeClass("selected");var a=[];g.filter(":selected").each(function(){a.push(d(this).data("optionIndex"))});k.not(".optgroup").filter(function(b){return-1<d.inArray(b,a)}).addClass("selected")}).focus(function(){e.addClass("focused")}).blur(function(){e.removeClass("focused")}),c>e.height()&&a.keydown(function(a){38!=a.which&&37!=a.which&&33!=a.which||f.scrollTop(f.scrollTop()+k.filter(".selected").position().top-h);40!=a.which&&39!=a.which&&34!=a.which||f.scrollTop(f.scrollTop()+k.filter(".selected:last").position().top-f.innerHeight()+2*h)}))}var g=d("option",a),x="";a.is("[multiple]")?C():v()};b();a.on("refresh",function(){a.next().remove();b()})}})})}})(jQuery);
}).call(this,require("9FoBSB"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_d26e62ce.js","/")
